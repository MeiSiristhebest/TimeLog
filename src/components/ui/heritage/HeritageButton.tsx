...
import { Text, ActivityIndicator, StyleSheet, ViewStyle, TextStyle, Pressable } from 'react-native';
import Animated, {
    useSharedValue,
    useAnimatedStyle,
    withSpring,
...
export function HeritageButton({
    ...
    const getSizeStyles = (): { container: ViewStyle; text: TextStyle; iconSize: number } => {
        switch (size) {
            ...
            default:
                return {
                    container: { height: 56, paddingHorizontal: theme.spacing.lg, borderRadius: theme.radius.md },
                    text: { fontSize: 16 },
                    iconSize: 20,
                };
        }
