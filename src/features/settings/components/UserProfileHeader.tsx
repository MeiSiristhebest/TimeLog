      ...
      <AnimatedPressable
        ...
        <View
          ...
          <View className="relative pt-1">
            {avatar ? (
              <Image source={{ uri: avatar }} className="w-16 h-16 rounded-2xl border-[0.5px] border-black/10" contentFit="cover" />
            ) : (
              <View className="w-16 h-16 rounded-2xl items-center justify-center" style={{ backgroundColor: colors.surfaceDim }}>
