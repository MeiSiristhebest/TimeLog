...
export const APP_ROUTES = {
  ...
  SETTINGS_LANGUAGE: '/(tabs)/settings/language' as Href,
  SETTINGS_DAILY_GOAL: '/(tabs)/settings/daily-goal' as Href,
  ...
  SETTINGS_ROLE: '/(tabs)/settings/role',
  SETTINGS_RECOVERY_CODE: '/(tabs)/settings/recovery-code',
  SETTINGS_DEVICE_CODE: '/(tabs)/settings/device-code' as Href,
  SETTINGS_DEVICE_MANAGEMENT: '/(tabs)/settings/device-management' as Href,
  SETTINGS_NOTIFICATIONS: '/(tabs)/settings/notifications',
  SETTINGS_FAMILY_SHARING: '/(tabs)/settings/family-sharing' as Href,
  FAMILY_MEMBERS: '/(tabs)/family' as Href,
  INVITE: '/invite' as Href,
  ACCEPT_INVITE: '/accept-invite' as Href,
  FAMILY_ASK_QUESTION: '/family-ask-question' as Href,
  ROLE: '/role' as Href,
  LOGIN: '/login',
  SIGNUP: '/signup',
