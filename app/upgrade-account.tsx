...
export default function UpgradeAccountScreen(): JSX.Element {
    ...
    const storytellerName = (params.name as string) || 'your loved one';
    ...
    const handleUpgrade = async () => {
        ...
        try {
            const { recoveryCode } = await upgradeAnonymousAccount(email, password, displayName);

            await Haptics.notificationAsync(Haptics.NotificationFeedbackType.Success);

            // Show success with recovery code
            ...
            HeritageAlert.show({
                ...
                message: error instanceof Error ? error.message : 'Failed to upgrade account. Please try again.',
                variant: 'error',
            });
        } finally {
            ...
            <ScrollView
                ...
                <View style={[styles.infoCard, { backgroundColor: `${theme.colors.primary}08` }]}>
                    ...
                    <AppText style={[styles.infoText, { color: theme.colors.textMuted }]}>
                        Set up an email and password to secure this account. This will allow logging in on other devices and prevent data loss.
                    </AppText>
                </View>
                ...
                <View style={[styles.warningBox, { backgroundColor: `${theme.colors.warning}15` }]}>
                    ...
                    <AppText style={[styles.warningText, { color: theme.colors.warning }]}>
                        Make sure to save these credentials securely. They will be needed to login on other devices.
                    </AppText>
                </View>
